...
<details>
  <summary>Can I export data from the CCGD?</summary>

Absolutely. The whole table can be downloaded on the search page or directly at the link below. Alternatively, filtering using the inputs on the search page allows for retrieval a modified export file.
